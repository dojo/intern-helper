 ...
 */
export declare function aroundJoinPoint<F extends GenericFunction<T>, T>(
	joinPoint: F,
	advice: JoinPointAroundAdvice<T>
): F;
/**
 ...
 * @return A handle which will remove the aspect when destroy is called
 */
export declare function aroundObject(
	target: Targetable,
	methodName: string | symbol,
 ...
 * @return A handle which will remove the aspect when destroy is called
 */
export declare function around(
	target: Targetable,
	methodName: string | symbol,
	advice: ((previous: Function) => Function)
): Handle;
 ...
 * @return A handle which will remove the aspect when destroy is called
 */
export declare function beforeObject(
	target: Targetable,
	methodName: string | symbol,
