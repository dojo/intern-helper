...
export declare function emit<T, O extends EventObject<T> = EventObject<T>>(
	target: Evented<any, T, O>,
	event: O
): boolean;
export declare function emit<O extends EventObject<string> = EventObject<string>>(
...
export declare function once<
	...
	O extends EventObject<T> = EventObject<T>
>(target: Evented<M, T, O>, type: K | K[], listener: EventCallback<M[K]>): Handle;
export declare function once<T, O extends EventObject<T> = EventObject<T>>(
	target: Evented<any, T, O>,
	type: T | T[],
	listener: EventCallback<O>
): Handle;
 ...
 */
export declare function pausable<
	M extends CustomEventTypes,
	T,
	K extends keyof M = keyof M,
	O extends EventObject<T> = EventObject<T>
>(target: Evented<M, T, O>, type: K | K[], listener: EventCallback<M[K]>): PausableHandle;
export declare function pausable<T, O extends EventObject<T> = EventObject<T>>(
	target: Evented<any, T, O>,
	type: T | T[],
	listener: EventCallback<O>
): PausableHandle;
