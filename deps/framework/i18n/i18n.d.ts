 ...
 */
export declare type LocaleTranslations<T extends Messages> =
	| Partial<T>
	| {
			default?: Partial<T>;
		};
 ...
 */
export declare function formatMessage<T extends Messages>(
	bundle: Bundle<T>,
	key: string,
 ...
 */
export declare function getMessageFormatter<T extends Messages>(
	bundle: Bundle<T>,
	key: string,
	locale?: string
): MessageFormatter;
 ...
 */
export declare function setLocaleMessages<T extends Messages>(
	bundle: Bundle<T>,
