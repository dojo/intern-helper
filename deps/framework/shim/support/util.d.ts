 ...
 */
export declare function getValueDescriptor<T>(
	value: T,
	enumerable?: boolean,
	writable?: boolean,
...
export declare function wrapNative<T, U, V, R>(
	nativeFunction: (arg1: U, arg2: V) => R
): (target: T, arg1: U, arg2: V) => R;
export declare function wrapNative<T, U, V, W, R>(
	nativeFunction: (arg1: U, arg2: V, arg3: W) => R
): (target: T, arg1: U, arg2: V, arg3: W) => R;
export declare function wrapNative<T, U, V, W, X, R>(
	nativeFunction: (arg1: U, arg2: V, arg3: W) => R
): (target: T, arg1: U, arg2: V, arg3: W) => R;
export declare function wrapNative<T, U, V, W, X, Y, R>(
