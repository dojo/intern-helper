...
export declare type StoreContainerPath<
	S,
...
export declare type StoreContainer<T extends WidgetBase<any, any>> = Constructor<
 ...
 */
export declare function storeInject<S>(
	config: StoreInjectConfig<S>
): (target: any, propertyKey?: string | undefined, descriptor?: PropertyDescriptor | undefined) => void;
export declare function StoreContainer<S = any, W extends WidgetBase<any, any> = WidgetBase<any, any>>(
 ...
 */
export declare function createStoreContainer<S>(): <W extends WidgetBase<any, any>>(
	component: string | symbol | Constructor<W>,
	name: string | symbol,
	{
		paths,
		getProperties
		...
		paths?:
			| StoreContainerPath<
					...
					keyof S,
					keyof S[keyof S],
					keyof S[keyof S][keyof S[keyof S]],
					keyof S[keyof S][keyof S[keyof S]][keyof S[keyof S][keyof S[keyof S]]],
					keyof S[keyof S][keyof S[keyof S]][keyof S[keyof S][keyof S[keyof S]]][keyof S[keyof S][keyof S[keyof S]][keyof S[keyof S][keyof S[keyof S]]]]
				>[]
			| undefined;
		getProperties: GetProperties<Store<S>, W>;
	}
