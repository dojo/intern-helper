...
export declare function processExecutor<T = any, P extends object = DefaultPayload>(
	id: string,
 ...
 */
export declare function createProcess<T = any, P extends object = DefaultPayload>(
	id: string,
	commands: Commands<T, P>,
