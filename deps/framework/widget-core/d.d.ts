 ...
 */
export declare function isWNode<W extends WidgetBaseInterface = DefaultWidgetBaseInterface>(
	child: DNode<W>
): child is WNode<W>;
/**
...
export declare function decorate<T extends DNode>(dNodes: DNode[], options: DecorateOptions<T>): DNode[];
export declare function decorate<T extends DNode>(
	dNodes: DNode | DNode[],
 ...
 */
export declare function w<W extends WidgetBaseInterface>(
...
export declare function v(
	tag: string,
	properties: DeferredVirtualProperties | VNodeProperties,
	children?: DNode[]
): VNode;
